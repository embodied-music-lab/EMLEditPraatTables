...
2. Click **EML: Edit Table...** in the dynamic action buttons
...
If the full EML Praat Tools plugin (`plugin_EML_Praat_Tools`) is installed, this standalone plugin disables itself automatically — the table editor is included in that suite. No conflicts, no duplicate menu entries.

## Requirements

- Tested on Praat 6.4.x)
